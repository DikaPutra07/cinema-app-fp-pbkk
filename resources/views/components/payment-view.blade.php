            ...
            <div class="card mx-auto p-3">
                <form class="card-details ">
                    ...
                    <div class="form-group mb-3 mt=3">
                        <p class="text-warning mb-0">Card or Phone Number</p> <input type="text" name="card-num" placeholder="1234 5678 9012 3457" size="17" id="cno" minlength="19" maxlength="19">
                        <p id="card-number-error" class="text-danger"></p>
                    </div>
                    <div class="form-group">
                        <p class="text-warning mb-0">Account's Name</p> <input type="text" name="name" placeholder="Name" size="17">
