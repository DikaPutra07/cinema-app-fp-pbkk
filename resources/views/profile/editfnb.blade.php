...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col personal-info">
            ...
            <form class="form-horizontal" role="form" method="POST"  action="{{ route('foodandbeverages-update', ['fnb' => $fnb->id]) }}" enctype="multipart/form-data" >
                @method('patch')
                @csrf
                <div class="form-group">
                    <label class="col-lg-3 control-label">Product Name:</label>
                    <div class="col-lg-8">
                        <input name="name" class="form-control" type="text" value="{{ $fnb->name }}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input name="price" class="form-control" type="text" value="{{ $fnb->price }}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input name="image" class="form-control" type="file" value="{{ $fnb->image }}">
                    ...
                    <div class="col-lg-8">
                        <select name="food_beverage_category_id" class="form-control">
                            @foreach ($foodBeverageCategories as $fbc)
                                <option value="{{ $fbc->id }}" {{ $fnb->food_beverage_category_id == $fbc->id ? 'selected' : '' }}>{{ $fbc->name }}</option>
                            @endforeach
                        </select>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        ...
                        <textarea name="description" class="form-control">{{ $fnb->description }}</textarea>
